...
function App() {
  ...
  return (
    <>
      <main
        className="m-5 md:max-w-xl md:mx-auto lg:max-w-2xl 
        ...
        {showInvoice ? (
          ...
          <>
            ...
            <div className="flex flex-col justify-center">
              <article className="md:grid grid-cols-2 gap-10 sm:grid">
              ...
              <article className="md:grid grid-cols-3 gap-10 sm:grid">
                <div className="flex flex-col">
              ...
              <article className="md:grid grid-cols-2 gap-10 sm:grid md:mt-20 sm:mt-20">
                <div className="flex flex-col">
